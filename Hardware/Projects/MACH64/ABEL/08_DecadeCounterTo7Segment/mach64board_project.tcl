...
########## Tcl recorder starts at 01/16/12 15:14:45 ##########
...
########## Tcl recorder end at 01/16/12 15:14:45 ###########


########## Tcl recorder starts at 01/16/12 15:14:49 ##########
...
########## Tcl recorder end at 01/16/12 15:14:49 ###########


########## Tcl recorder starts at 01/16/12 15:14:58 ##########
...
########## Tcl recorder end at 01/16/12 15:14:58 ###########


########## Tcl recorder starts at 01/16/12 15:15:14 ##########
...
########## Tcl recorder end at 01/16/12 15:15:14 ###########


########## Tcl recorder starts at 01/16/12 15:15:22 ##########
...
# Commands to make the Process: 
# Hierarchy
if [runCmd "\"$cpld_bin/ahdl2blf\" bcdupcounter.abl -ojhd only -def _AMDMACH_ _MACH_ _LSI5K_ _LATTICE_ _PLSI_ _MACH4ZE_  -err automake.err"] {
	return
} else {
	vwait done
	if [checkResult $done] {
...
########## Tcl recorder end at 01/16/12 15:15:22 ###########


########## Tcl recorder starts at 01/16/12 15:15:27 ##########
...
########## Tcl recorder end at 01/16/12 15:15:27 ###########


########## Tcl recorder starts at 01/16/12 15:15:46 ##########
...
if [runCmd "\"$cpld_bin/ahdl2blf\" bcdupcounter.abl -mod BcdUpCounter -ojhd compile -ret -def _AMDMACH_ _MACH_ _LSI5K_ _LATTICE_ _PLSI_ _MACH4ZE_  -err automake.err "] {
	return
} else {
	vwait done
	if [checkResult $done] {
...
########## Tcl recorder end at 01/16/12 15:15:46 ###########


########## Tcl recorder starts at 01/16/12 15:16:01 ##########
...
########## Tcl recorder end at 01/16/12 15:16:01 ###########

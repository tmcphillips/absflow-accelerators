...
alias com {
  echo "\[exec\] com"
  vlog -sv "$QSYS_SIMDIR/lowpass_filter_dut_tb/simulation/submodules/verbosity_pkg.sv"                                            -work work         
  vlog -sv "$QSYS_SIMDIR/lowpass_filter_dut_tb/simulation/submodules/avalon_utilities_pkg.sv"                                     -work work         
  vlog -sv "$QSYS_SIMDIR/lowpass_filter_dut_tb/simulation/submodules/avalon_mm_pkg.sv"                                            -work work         
  vlog -sv "$QSYS_SIMDIR/lowpass_filter_dut_tb/simulation/submodules/lowpass_filter_avalon_st.sv"                                 -work work                               
  vlog -sv "$QSYS_SIMDIR/lowpass_filter_dut_tb/simulation/submodules/altera_avalon_st_source_bfm.sv" -L altera_common_sv_packages -work work  
  vlog -sv "$QSYS_SIMDIR/lowpass_filter_dut_tb/simulation/submodules/altera_avalon_st_sink_bfm.sv"   -L altera_common_sv_packages -work work
  vlog -sv "$QSYS_SIMDIR/lowpass_filter_dut_tb/simulation/submodules/altera_avalon_mm_master_bfm.sv" -L altera_common_sv_packages -work work
  vlog -sv "$QSYS_SIMDIR/lowpass_filter_dut_tb/simulation/submodules/altera_avalon_reset_source.sv"  -L altera_common_sv_packages -work work 
  vlog -sv "$QSYS_SIMDIR/lowpass_filter_dut_tb/simulation/submodules/altera_avalon_clock_source.sv"  -L altera_common_sv_packages -work work 
  vlog -sv "$QSYS_SIMDIR/lowpass_filter_dut_tb/simulation/submodules/lowpass_filter_dut.v"                                        -work work           
  vlog     "$QSYS_SIMDIR/lowpass_filter_dut_tb/simulation/lowpass_filter_dut_tb.v"                                                                                        
}
